...
const serviceRoleOnly = new Set([
  ...
  'apply_electrician_reliability_cooldowns',
  'consume_guest_action_token',
  'create_guest_otp_delivery',
  'create_notification',
  'guest_job_payload',
  'mark_guest_otp_delivery',
  'audit_direct_job_status_write',
  'detect_predictive_operational_risks',
  'enforce_job_status_event',
  'operational_alert_dedupe_key',
  'process_dispatch_queue',
  'apply_operational_escalations',
  'claim_operation_request',
  'complete_operation_request',
  'prioritize_dispatch_queue',
  'rebuild_all_projections',
  'rebuild_all_job_projections',
  'rebuild_all_job_state_projections',
  'refresh_predictive_operational_alerts',
  'replay_all_job_events',
  'replay_job_events',
  'replay_job_events_internal',
  'run_operational_recovery',
  'run_operational_automation',
  'sync_electrician_reliability_aliases',
  'sync_electrician_snapshot_reliability_aliases',
  'sync_all_job_state_projections',
  'sync_job_event_payload',
