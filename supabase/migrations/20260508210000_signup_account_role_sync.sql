-- Keep Supabase Auth as the identity source and app role tables as the app source of truth.
...
revoke all on function public.ensure_app_account_for_current_user() from anon;
