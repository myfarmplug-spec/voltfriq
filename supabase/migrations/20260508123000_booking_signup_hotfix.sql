-- Emergency booking/signup hotfix:
-- - prevent guest booking dispatch from crashing on null customer notifications
-- - force production service areas to the canonical Port Harcourt list
